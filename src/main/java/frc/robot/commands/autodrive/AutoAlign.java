  ...
  */
  ...
  public void execute() {
    ...
    double thetaPoseError =
        Pose.getRotation().getRadians() - drivePose.getRotation().getRadians();
    ...
    double turnOutput = MathUtil.applyDeadband(rotationController.calculate(thetaPoseError, 0), 0.05);
