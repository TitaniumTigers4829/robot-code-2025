...
//     // targets.
//     // Instance variables
//     shooterCameraSim = new PhotonCameraSim(getSimulationCamera(Limelight.BACK),
// cameraProperties);
//     frontLeftCameraSim =
...
//     visionSim.addCamera(shooterCameraSim, VisionConstants.BACK_TRANSFORM); // check inverse
// things
