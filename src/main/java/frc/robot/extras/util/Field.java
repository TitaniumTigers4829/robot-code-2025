...
/**
 * The Field class encapsulates field dimensions and obstacles for the repulsor field planner. It
 * provides a static list of obstacles that represent reefs, walls, and source boundaries.
 */
public class Field {
  ...
  /**
   * A static list of obstacles placed on the field. This includes reef obstacles, wall obstacles,
   * and source line obstacles.
   */
  public static final List<Obstacle> OBSTACLES =
      List.of(
          // Reef obstacles
          ...
          new LineObstacle(
              new Translation2d(0, SOURCE_Y), new Translation2d(SOURCE_X, 0), 0.5, 0.5),
          new LineObstacle(
