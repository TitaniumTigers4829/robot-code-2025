...
public class SimGyroConfig implements StructSerializable {
    ...
    public SimGyroConfig(double averageDriftingIn30SecsMotionlessDeg, double velocityMeasurementStandardDeviationPercent) {
    ...
    public SimGyroConfig withAverageDriftingIn30SecsMotionlessDeg(double averageDriftingIn30SecsMotionlessDeg) {
        this.averageDriftingIn30SecsMotionlessDeg = averageDriftingIn30SecsMotionlessDeg;
        return this;
    }

    public SimGyroConfig withVelocityMeasurementStandardDeviationPercent(double velocityMeasurementStandardDeviationPercent) {
        this.velocityMeasurementStandardDeviationPercent = velocityMeasurementStandardDeviationPercent;
        return this;
    }
    ...
    // public static final Struct<SimGyroConfig> struct = ProceduralStructGenerator.genObjectNoUnpack(SimGyroConfig.class);
}
