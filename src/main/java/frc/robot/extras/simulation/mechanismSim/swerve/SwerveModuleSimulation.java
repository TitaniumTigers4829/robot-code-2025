...
public class SwerveModuleSimulation {
   ...
   *
   * <p>If you are using {@link SimulatedField#overrideSimulationTimings(double, int)} to use custom
   ...
   *
   * <p>To get the final wheel rotations, use {@link #getDriveEncoderFinalPositionRad()}.
   *
   ...
   *
   * <p>The values of {@link #getTurnRelativeEncoderPositionRad()} are cached at each sub-tick and
   * can be retrieved using this method.
   *
   ...
   *
   * <p>The values of {@link #getTurnAbsolutePosition()} are cached at each sub-tick and can be
