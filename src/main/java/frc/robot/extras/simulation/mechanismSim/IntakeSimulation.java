...
public abstract class IntakeSimulation extends BodyFixture {
  ...
  private final Queue<GamePieceSimulation> gamePiecesToRemove;
  ...
  private static Rectangle getIntakeRectangle(
      AbstractDriveTrainSimulation driveTrainSimulation, double with, IntakeSide side) {
  ...
  public IntakeSimulation(
      SimulatedField arena,
      AbstractDriveTrainSimulation driveTrainSimulation,
      Translation2d startPointOnRobot,
      Translation2d endPointOnRobot,
      int capacity) {
    this(
        arena,
        driveTrainSimulation,
        new Segment(
            GeomUtil.toDyn4jVector2(startPointOnRobot), GeomUtil.toDyn4jVector2(endPointOnRobot)),
        capacity);
  }
  ...
  public Queue<GamePieceSimulation> getGamePiecesToRemove() {
